...
async def get_user_posts(
    username: str,
    sort: str = Query("new", regex="^(new|hot|top)$", description="Sort criteria for submitted posts"),
...
async def get_user_comments(
    username: str,
    sort: str = Query("new", regex="^(new|hot|top)$", description="Sort criteria for comments"),
    time: str = Query("all", regex="^(hour|day|week|month|year|all)$", description="Timeframe filter (only active when sort='top')"),
